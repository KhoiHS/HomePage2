...
const Coin = () => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.itemContainer}>
      ...
      <Text style={[styles.itemText, item.text3 === '4,3%' && styles.redText, item.text3 === '4,48%' && styles.greenText]}>
        {item.text3}
      </Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tableHeader}>
        ...
        <Text style={styles.tableHeaderText}>Change (24)</Text>
      </View>
      <FlatList
        data={data}
      ...
      <View style={styles.taskbar}>
        ...
        <View style={styles.taskItem}>
          <TouchableOpacity onPress={handleNavigate}>
            <Image source={require('../assets/task4.png')} style={styles.taskIcon} />
